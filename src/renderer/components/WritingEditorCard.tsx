...
export function WritingEditorCard({
  ...
  return (
    <section
      className="flex min-h-0 flex-col rounded-xl border border-base-300/70 bg-base-100 p-5"
    ...
    >
      ...
      <div className="mb-4 grid gap-3 rounded-xl border border-base-300 bg-base-200/45 p-4">
        ...
        {generatedPrompt ? (
          <p className="rounded-xl bg-base-100 p-3 text-sm leading-6 text-base-content/75">{generatedPrompt.text}</p>
        ) : null}
      ...
      <textarea
        className="textarea textarea-ghost writing-practice-surface min-h-[28rem] flex-1 resize-none rounded-xl border border-base-300/70 bg-base-100 p-6 text-[1.08rem] leading-8 outline-none transition focus:border-primary/60 lg:min-h-0"
        value={content}
